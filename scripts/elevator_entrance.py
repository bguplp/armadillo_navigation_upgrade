...
import numpy as np
from armadillo_navigation_upgrade.srv import elevator_entrance, elevator_entranceRequest #, ser_message, ser_messageRequest
import shlex
...
def first_floor_func():
    ...
    input_pose.pose.position.y = 1.3
    ...
    input_pose.pose.orientation = Quaternion(*tf.transformations.quaternion_from_euler(0,0,1.719))
    ...
    input_pose.header.stamp = rospy.Time.now()
    input_pose.header.frame_id = 'map'
    input_pose.pose.position.x = -0.283
    input_pose.pose.position.y = 3.253
    input_pose.pose.position.z = 0
    #input_pose.pose.orientation.x = 
    #input_pose.pose.orientation.y =
    #input_pose.pose.orientation.z =
    ...
    input_pose.header.stamp = rospy.Time.now()
    input_pose.header.frame_id = 'map'
    input_pose.pose.position.x = -0.15 
    input_pose.pose.position.y = 3.3
    input_pose.pose.position.z = 0
    #input_pose.pose.orientation.x = 
    #input_pose.pose.orientation.y =
    #input_pose.pose.orientation.z =
...
def second_floor_func():
    ...
    input_pose.header.stamp = rospy.Time.now()
    input_pose.header.frame_id = 'map'
    input_pose.pose.position.x = 6.55 
    input_pose.pose.position.y = 6.35
    input_pose.pose.position.z = 0
    #input_pose.pose.orientation.x = 
    #input_pose.pose.orientation.y =
    #input_pose.pose.orientation.z =
